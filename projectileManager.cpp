...
{
	IMAGEMANAGER->addFrameImage("ºÒ²ÉÅ¸°İ", "image/skill/ºÒ²ÉÅ¸°İ.bmp", 600, 400, 5, 4, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("ºÒ²ÉÆÄÆ¼Å¬2", "image/skill/ºÒ²ÉÆÄÆ¼Å¬.bmp", 210, 120, 6, 4, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("ºÒ²ÉÆÄÆ¼Å¬", "image/skill/ºÒ²ÉÆÄÆ¼Å¬2.bmp", 700, 400, 7, 4, true, RGB(255, 0, 255));
